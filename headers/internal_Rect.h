...
//#endif
	...
	public:
		...
		inline SFG::iVector2<T> center() const { return SFG::iVector2<T>(left + width / T(2), top + height / T(2)); }
		...
		inline SFG::iVector2<T> topLeft() const { return SFG::iVector2<T>(left, top); }
