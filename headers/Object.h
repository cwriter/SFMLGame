...
public:
	...
	inline void setGovernor(Module* gov) { this->m_governor = gov; }

	int parseSourceString(const sf::String& str);

	inline operator sf::Texture&() { return *this->m_texture.getElement(); }

	void setTexture(sf::Texture& t) { this->m_texture.reset(&t); }
	void setTexture(sf::Texture* t) { this->m_texture.reset(t); }

	sf::Texture& getTexture() { return *m_texture.getElement(); }
...
public:
	...
	inline const sf::Sprite& getSprite() const { return this->m_sprite; }
