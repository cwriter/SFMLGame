...
public:
	...
	inline std::vector<UIComponent*>& getComponentVector() { return this->m_components; }
private:
...
public:
	...
	UIComponent() {
		this->m_functions.resize(Function::FunctionListSize, [](void* data) { return 0; });
		hovered = false;
	}
	virtual ~UIComponent() {}
...
public:
	...
	virtual void setGrid(UIGrid* g) { this->m_grid = g; }
